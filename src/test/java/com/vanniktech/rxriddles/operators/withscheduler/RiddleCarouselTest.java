...
public class RiddleCarouselTest {
	...
	private static final String ACQUIRER_4 = "ACQUIRER_5";
	private static final String ACQUIRER_5 = "ACQUIRER_6";
	private static final String ACQUIRER_6 = "ACQUIRER_7";
	...
	public void emits_the_next_acquirer_after_interval() throws Exception {
		...
		testObserver.assertValues(ACQUIRER_1, ACQUIRER_2, ACQUIRER_3, ACQUIRER_1, ACQUIRER_2);
		...
		testObserver.assertValues(ACQUIRER_1, ACQUIRER_2, ACQUIRER_3, ACQUIRER_1, ACQUIRER_2, ACQUIRER_4);

		scheduler.advanceTimeBy(CAROUSEL_INTERVAL.toMillis(), TimeUnit.MILLISECONDS);
		testObserver.assertValues(ACQUIRER_1, ACQUIRER_2, ACQUIRER_3, ACQUIRER_1, ACQUIRER_2, ACQUIRER_4, ACQUIRER_5);
	}
}